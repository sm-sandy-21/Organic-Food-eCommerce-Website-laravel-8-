...
<div id="contact-page" class="container">
    <div class="bg">
        <div class="row">    		
            <div class="col-sm-5">    			   			
                <h2 class="title text-center"><strong>Get In Touch</strong></h2>    			    				    				               
                </div>
            </div>			 		
        </div>  
        <?php
        ...
        <div class="row">  	
            <div class="col-sm-5">
                <div class="contact-form">
                    ...
                    <form action="{{ url('/save-contact') }}" id="main-contact-form" class="contact-form row" method="post">
                        @csrf
