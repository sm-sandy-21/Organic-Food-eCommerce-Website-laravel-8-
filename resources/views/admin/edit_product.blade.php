...
<div class="row-fluid sortable">
	<div class="box span12">
		...
		<div class="box-content">
			<form class="form-horizontal" action="{{ url('/update',$product_info->product_id )}}" method="post" enctype="multipart/form-data">
				@csrf
				<fieldset>
					...
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" class="input-type" id="date01" value="{{ $product_info->product_name }}" >
						</div>
					</div>
					...
					<div class="control-group">
						...
						<div class="controls">
                            <input type="text" class="input-type" id="date01" value="{{$product_info->product_price }}" required>
					...
					<div class="control-group">
						...
						<div class="controls">
							<input class="input-file uniform_on" value="{{$product_info->product_image }}" id="fileInput" type="file">
						</div>
					</div>
					...
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" class="input-type" id="date01" value="{{$product_info->product_size }}" required>
						</div>
					</div>
					...
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" class="input-type" id="date01" value="{{$product_info->product_color }}" required>
						</div>
					</div>
